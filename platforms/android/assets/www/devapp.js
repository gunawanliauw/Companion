jQuery.sap.declare("companion.devapp");
jQuery.sap.require("companion.devlogon");

companion.devapp = {
	smpInfo: {},
	//the variable hold companion.devlogon instance
	devLogon: null,
		...
		if (window.sap_webide_FacadePreview) {
			...
			$.getJSON("project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new companion.devlogon();
